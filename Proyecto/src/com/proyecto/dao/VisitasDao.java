...
public class VisitasDao {
	...
	public int AgregarVisita(Visitas v){    
	    String sql="insert into Visitas (idvisita, direccion, ciudad, fecha, resumen, observaciones, rut_id, empleado_rutempleado) values   ( ' "+v.getIDVisita() + "', '"+v.getDireccion()+"','"+v.getCiudad()+"','"+v.getFecha()+"','"+v.getResumen()+"','"+v.getObservaciones()+"','"+v.getRut_Id()+"','"+v.getEmpleado_RutEmpleado()+"')";
