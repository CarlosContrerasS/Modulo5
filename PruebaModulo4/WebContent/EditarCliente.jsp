    ...
    <li><a href="#">Pagos</a>
        ...
        <li><a href="${pageContext.request.contextPath}/Global">Informe Global</a>
          ...
          <form method="get" action="EditarCliente" style="margin-bottom: 3%;">
              B�squeda Cliente por Rut: <input type="search" name="rut" placeholder="Coloque el RUT sin puntos ni gui�n.">
            ...
            <div class="formulario" >
                <form method="post" action="EditarCliente">
                    ...
                    <input type="text" class="campo_formulario" name="nombre" value="${regcli.getNombre()}"/><br/>
                    <label for="telefono">Telefono </label><br/>
                    <input type="tel" class="campo_formulario" name="telefono" value="${regcli.getTelefono()}" /><br/>
                    <label for="correo">Correo electr�nico </label><br/>
                    <input type="email" class="campo_formulario" name="correo" value="${regcli.getCorreoelectronico()}"/><br/>
                    <label for="rubro">Rubro </label><br/>
                    <input type="text" class="campo_formulario" name="rubro" value="${regcli.getRubro()}"/><br/>
                    <label for="direccion">Direcci�n </label><br/>
                    <input type="text" class="campo_formulario" name="direccion" value="${regcli.getDireccion()}"/><br/>
